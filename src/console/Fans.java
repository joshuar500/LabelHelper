...
public class Fans{
    ...
    Map<String, String> fanMap = new HashMap<String, String>();

    public void putSilenXFansInMap() {
        fanMap.put("1114", "IXP-11-14");
        fanMap.put("1314", "IXP-13-14");
        fanMap.put("3408", "IXP-34-08");
    }

    public String findFansInMap(String key) {
        ...
        String formatted = sb.toString().replaceAll("\\s", "");
